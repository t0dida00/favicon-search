    ...
    <div className="group/sidebar-wrapper has-[[data-variant=inset]]:bg-sidebar flex min-h-svh w-full">
      <main className="flex min-h-screen w-full flex-col items-center">
        <div className="flex w-full flex-1 flex-col items-center gap-10 md:gap-20">
          <NavBar />
          <div className="flex flex-col gap-10 md:gap-20 px-5">
            <div className="container flex flex-col items-center gap-16" id="hero">
            ...
            <section id="benefits" className="container pt-16 md:w-full md:pt-24">
            ...
            <section id="marquee" className="max-w-[300px] sm:container mx-auto w-screen px-4 pt-16 md:w-full md:pt-24">
        ...
        <footer className="container mt-10 flex w-full gap-8 border-t p-4 text-center text-xs md:items-center lg:justify-center">
          <div className="flex flex-col items-start gap-1 text-sm lg:flex-row lg:items-center xl:gap-1">
